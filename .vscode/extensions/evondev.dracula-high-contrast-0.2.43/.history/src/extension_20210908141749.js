...
function activate(context) {
  this.extensionName = "evondev.dracula-high-contrast";
  this.cntx = context;
  ...
  if (this.extension) {
    ...
    const prevVersion = context.globalState.get(
      `${this.extensionName}.version`
    );
